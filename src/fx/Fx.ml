...
external [@mel.module "../shared/fx"] [@mel.scope "Fx"] ok :
  'v -> ('v, 'e, 'd) t = "Ok"

external [@mel.module "../shared/fx"] [@mel.scope "Fx"] err :
  'e -> ('v, 'e, 'd) t = "Err"

external [@mel.module "../shared/fx"] [@mel.scope "Fx"] sync :
  ('d -> ('v, 'e, 'd) t) -> ('v, 'e, 'd) t = "Sync"

external [@mel.module "../shared/fx"] [@mel.scope "Fx"] async :
  ('d -> ('v, 'e, 'd) t Js.Promise.t) -> ('v, 'e, 'd) t = "Async"

external [@mel.module "../shared/fx"] [@mel.scope "Fx"] ask :
  unit -> ('r, 'e, 'r) t = "ask"
...
external [@mel.module "../shared/fx"] [@mel.scope "Fx"] asyncAll2 :
  ('v1, 'e, 'd) t * ('v2, 'e, 'd) t -> ('v1 * 'v2, 'e, 'd) t = "asyncAll"

external [@mel.send] catch :
  ('v, 'e, 'd) t -> ('e -> ('w, 'f, 'd) t) -> ('w, 'f, 'd) t = "catch"
